...
function Trace (config) {
  debug(dbgFormat(dbgFormat.levels.INFO, 'Trace',
...
Trace.prototype.getTransactionId = function () {
  ...
  debug(dbgFormat(dbgFormat.levels.INFO, 'getTransactionId',
    transactionId))
...
module.exports.create = function () {
  if (process.env.NODE_ENV === 'test') {
    debug(dbgFormat(dbgFormat.levels.WARN, 'create',
