...
describe('The collector module', function () {
  ...
  describe('events', function () {
    ...
    it('stores the "ServerRecieve" events with no traceData', function () {
      var collector = new Collector({});
    ...
    it('stores the "ServerRecieve" events with traceData', function () {
      var collector = new Collector({});
      ...
      var origin = '12312312';
      var parent = '1';
      var traceData = [origin, parent].join('-');
