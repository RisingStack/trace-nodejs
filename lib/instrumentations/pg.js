...
function wrapNative (native, agent, version) {
  ...
  if (!version) {
    debug(dbgFormat(dbgFormat.levels.ERROR, 'postgres', 'cannot determine postgres version. ' +
      '(No package.json?) Native queries won\'t be instrumented.'))
  } else if (!semver.satisfies(version, '>= 4.0.0')) {
    debug(dbgFormat(dbgFormat.levels.WARN, 'postgres', 'you are using node-postgres version ' +
