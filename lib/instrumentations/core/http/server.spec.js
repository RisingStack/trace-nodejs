...
describe('The http.Server.prototype wrapper module', function () {
  ...
  it('calls agent.tracer.collector.serverRecv with CACHE_MODE=RETAIN_UNTIL_SS', function () {
    var s = server(original, agent)
    ...
    expect(agent.tracer.collector.serverRecv.args[0][2].cacheMode)
      .to.eql(agent.tracer.collector.CACHE_MODES.RETAIN_UNTIL_SS)
  })
