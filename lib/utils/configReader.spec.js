...
describe('Config Reader module', function () {
  ...
  it('can find reporter parameters by default config', function () {
    var config = { appName: 'test', apiKey: 'test' }
    var configReader = ConfigReader.create()
    this.sandbox.stub(configReader, '_getDefaultConfig', function () {
      return config
    })
    ...
    expect(getReporterConfigStub).to.have.been.calledWith(config)
  })

  it('can find reporter parameters by environment variable config', function () {
    var config = { appName: 'test', apiKey: 'test' }
    var configReader = ConfigReader.create()
  ...
  it('can find reporter parameters by parameter config', function () {
    var config = { appName: 'test', apiKey: 'test' }
    var configReader = ConfigReader.create(config)
