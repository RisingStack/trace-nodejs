...
describe('Config Reader module', function () {
  ...
  describe('config sources', function () {
    it('default config should be checked', function () {
      ...
      var getDefaultConfigStub = this.sandbox.stub(configReader, '_getDefaultConfig').callsFake(function () {
        return {
          test: 'default',
    ...
    it('file config should be checked', function () {
      ...
      var getFileConfigStub = this.sandbox.stub(configReader, '_getFileConfig').callsFake(function () {
        return { test: 'file' }
      })
    ...
    it('environment variables should be checked', function () {
      ...
      var getEnvVarConfigStub = this.sandbox.stub(configReader, '_getEnvVarConfig').callsFake(function () {
        return { test: 'env' }
      })
    ...
    it('system configuration should be checked', function () {
      ...
      var getSystemConfigStub = this.sandbox.stub(configReader, '_getSystemConfig').callsFake(function () {
        return { test: 'system' }
      })
  ...
  describe('precedence', function () {
    it('file config should override default config', function () {
      ...
      this.sandbox.stub(configReader, '_getFileConfig').callsFake(function () {
        return { test: 'file' }
      })

      this.sandbox.stub(configReader, '_getDefaultConfig').callsFake(function () {
        return { test: 'default' }
      })
    ...
    it('environment variables config should override file config', function () {
      ...
      this.sandbox.stub(configReader, '_getEnvVarConfig').callsFake(function () {
        return { test: 'env' }
      })
    ...
    it('system config should override env var config', function () {
      ...
      this.sandbox.stub(configReader, '_getSystemConfig').callsFake(function () {
        return { test: 'system' }
      })
  ...
  it('does not throw error if TRACE_IGNORE_HEADERS is malformed, and uses the next highest priority source for the ignoreHeaders config', function () {
    ...
    this.sandbox.stub(configReader, '_readConfigFile').callsFake(function () {
    ...
    this.sandbox.stub(fs, 'statSync').callsFake(function () {
      return { }
    })
