...
var os = require('os')
var url = require('url')
var debug = require('debug')('risingstack/trace:config')
var defaults = require('lodash.defaults')
var format = require('util').format
var dbgFormat = require('./dbgFormat')
var fs = require('fs')
...
ConfigReader.prototype._getEnvVarConfig = function () {
  ...
  if (process.env.TRACE_IGNORE_HEADERS) {
    try {
      ...
      debug(dbgFormat(dbgFormat.levels.ERROR, 'getEnvVarConfig',
...
ConfigReader.prototype._isConfigFileExists = function (file) {
  ...
  if (failCounter < 2) {
    ...
    debug(dbgFormat(dbgFormat.levels.INFO, '_isConfigFileExists',
...
ConfigReader.prototype._readProcFile = function (name) {
  ...
  try {
    ...
    debug(dbgFormat(dbgFormat.levels.INFO, '_readProcFile',
